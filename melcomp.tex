...
\begin{figure}[pthb] % redo this. Is this log data?
...
To test/demonstrate such a procedure, let's consider the plots from Figure \ref{fig:corrected} and \ref{fig:590}.
