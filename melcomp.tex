...
\begin{figure}
\includegraphics[max width=0.7\textwidth]{figs/comp/predictingChromaticity/allComboSignals.pdf}
...
where $I_{\text{MB}}$ follows from Equation \ref{eq:iMBtri}, and $L_{\text{MB}}$ and $M_{\text{MB}}$ follow from Equation \ref{eq:MBTristim}.
...
\section{Physiological plausibility}
