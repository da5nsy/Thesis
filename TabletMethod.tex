...
\begin{figure}[hbtp]
\includegraphics[max width=\textwidth]{figs/tablet/PAMELAlights2.png}
\caption{\gls{SPD} of the 6 different channels available in the \gls{PAMELA} lighting rig. \hl{Will reformat and add axis labels}}
\label{fig:PAMELAlights2}
\end{figure}

\begin{figure}[hbtp]
\includegraphics[max width=\textwidth]{figs/tablet/PAMELAlights3.png}
\caption{As \ref{fig:PAMELAlights2} but additionally showing the independent high output white channel. \hl{Will reformat and add axis labels}}
\label{fig:PAMELAlights3}
\end{figure}
...
\begin{figure}[hbtp]
\includegraphics[max width=\textwidth]{figs/tablet/BM_SPD.png}
...
\begin{figure}[hbtp]
\includegraphics[max width=\textwidth]{figs/tablet/BM_GC.jpg}
\caption{Photo of the author performing the experiment in GC. Photo credit: Lindsay MacDonald.}
\label{fig:BM_GC}
\end{figure}

\begin{figure}[hbtp]
\includegraphics[max width=\textwidth]{figs/tablet/BM77.jpg}
