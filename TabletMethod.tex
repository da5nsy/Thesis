%
% To do after feedback from KC 
% ----------------------------
%
% Expand the results section for Experiment 2 by including a subplot (2 x 2) showing a) no exclusions, b)/c)/d) different exclusions applied, and assess the effect of applying such exclusions.
%
% Change the exclusion parameter for Exp 3 based on this (if needed after above)
%
% Mention naive will come later
%
% More info on naive - "how difficult did people seem to find it, how long did they take roughly would be nice."
