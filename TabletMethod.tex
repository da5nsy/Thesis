...
\begin{figure}[hbtp] %https://github.com/da5nsy/SAPS/commit/71a0bd0c4e9d983b49b48d6eb8ad38a152260498
...
\begin{figure}[hbtp] %https://github.com/da5nsy/SAPS/commit/ca27707d1fc4e2026fd700a9468592c14af24690
...
\begin{figure}[hbtp] %https://github.com/da5nsy/SAPS/blob/c03152d610a5469f293068c6e8ec2258f4842c94/SAPS_DataAnalysis.m
\includegraphics[max width=\textwidth]{figs/tablet/excl3.png} 
...
Data without exclusions is presented in Figure \ref{fig:exp2wo}
...
To consider the above information in practice, we need to perform a conversion into chromaticity space. For a simple analogy, let's consider a pixel shift of 6 pixels (the rough average standard deviation in each dimension, based on a visual analysis of Figure \ref{fig:BMtouch}). This would equate to a shift of 0.2742 in u*v* space, or a shift of 0.0003 in u'v' space %shouldn't this be differennt values for u' and v'? !!!!!!!!!
