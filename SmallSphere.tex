...
Data describing the characterisations of hardware follow. Figure \ref{fig:SSLEDs} shows the chromaticities of the adapting surrounds as recording during each session. 
