...
% align acronyms (add XYZ, CRI, RGB)
% images for interviews section?
% add more to museum guidelines summary
% add image for cct in museums
% would be nice to sort out the quote environments used throughout so that they were consistent, maybe something like https://tex.stackexchange.com/questions/162782/how-to-configure-redefine-the-quotation-environment-to-cite?rq=1