...
% melcomp meaningful names
% align acronyms (add XYZ, CRI, RGB)
% add back in lit review sections on colour rendering, in general and museums, and visitor needs
% images for interviews section?
% add more to museum guilines summary
% add image for cct in museums
%add cri to end of colorimetry