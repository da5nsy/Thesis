\chapter{The Large Sphere Experiment} %new name?
...
\begin{figure}[htbp]
%\includegraphics[max width=\textwidth]{figs/LargeSphere/LSsimdata.png}
...
\begin{figure}[htbp]
%\includegraphics[max width=\textwidth]{figs/LargeSphere/simVreal.png}
